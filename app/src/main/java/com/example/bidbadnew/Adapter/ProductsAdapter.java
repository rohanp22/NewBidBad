...
public class ProductsAdapter extends PagerAdapter {
    ...
    View mCurrentView;
    Date startDate1;
    TextView hr1, hr2, min1, min2, sec1, sec2, title, subtitle, mrp, entry;
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        entry = view.findViewById(R.id.entercontest);

        subtitle.setText("This is subtitle");
        mrp.setText("MRP "+ Symbol.rupee + currentProducts.get(position).getMrp());
        entry.setText("Enter contest for "+currentProducts.get(position).getSp());
