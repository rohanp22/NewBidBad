...
public class ProductAdapter1 extends RecyclerView.Adapter<ProductAdapter1.ProductAdapterViewHolder> implements ActionBottomDialogFragment.ItemClickListener {
...
//                        ActionBottomDialogFragment.TAG);
    ...
    public class ProductAdapterViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView hr1, hr2, min1, min2, sec1, sec2, subtitle, mrp, entry, title;
        ImageView imageView, imageView2, imageView3;
        ConstraintLayout constraintLayout;
        MaterialButton bidnow;
