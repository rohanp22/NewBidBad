...
public class ProfileFragment extends Fragment {
    ...
    public TextView order, cancelled, wonbids, invite, wishlist, payments, howtoplay, feedback, termsandconditions, privacypolicy, support, logout, name, profileLevel, noOfBids, noOfRewards, noOfWins;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        noOfBids = root.findViewById(R.id.profileBids);
        noOfRewards = root.findViewById(R.id.profileRewards);
        noOfWins = root.findViewById(R.id.profileWins);
        ...
        imageView = root.findViewById(R.id.profilePic);
        profileLevel = root.findViewById(R.id.profileLevel);
        ...
        termsandconditions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(root).navigate(R.id.action_navigation_notifications_to_termsandConditions);
            }
        });
        ...
        privacypolicy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(root).navigate(R.id.action_navigation_notifications_to_privacyPolicy);
            }
        });
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //zoomImageFromThumb(imageView, R.drawable.ic_baseline_person_24);
            }
        });
        ...
        howtoplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(root).navigate(R.id.action_navigation_notifications_to_itemFragment);
            }
        });
        ...
        try {
            Glide.with(getContext())
                    ...
                    .placeholder(getResources().getDrawable(R.drawable.ic_user_male))
                    .diskCacheStrategy(DiskCacheStrategy.NONE)
                    .into(imageView);
        } catch (Exception e){
            imageView.setImageDrawable(getResources().getDrawable(R.drawable.ic_user_male, null));
        }
        String str = SharedPrefManager.getInstance(root.getContext()).getUser().getFirstname();
        ...
        profileLevel.setText(findDifference(SharedPrefManager.getInstance(root.getContext()).getUser().getJoinedon(), dtf.format(now)));
        ...
        payments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(root).navigate(R.id.action_navigation_notifications_to_rewardsFragment);
            }
        });
        ...
        Call<Stat> call = RetrofitClient.getInstance().getMyApi().getStats(SharedPrefManager.getInstance(root.getContext()).getUser().getId());
        call.enqueue(new Callback<Stat>() {
            @Override
            public void onResponse(Call<Stat> call, Response<Stat> response) {
                if(response.body() != null) {
                    noOfBids.setText(response.body().getNumberofbids());
                    noOfWins.setText(response.body().getWins());
                }
            }
                   ...
                   String end_date)
    {
        ...
        try {
            ...
            String difference = "Bidder since ";

            if(difference_In_Years > 0){
                if(difference_In_Years == 1) {
                    difference += difference_In_Years + " Year and ";
                } else {
                    difference += difference_In_Years + " Years and ";
                }
            }
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        expandedImageView.setPivotX(200f);
        expandedImageView.setPivotY(200f);
