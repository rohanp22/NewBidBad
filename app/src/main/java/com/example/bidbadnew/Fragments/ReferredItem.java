...
import com.example.bidbadnew.ProductDescriptionArgs;
...
public class ReferredItem extends Fragment {
...
//        View view = inflater.inflate(R.layout.fragment_referred_item, container, false);
//        int val = ReferredItemArgs.fromBundle(getArguments()).getId1();
//        Log.d("Value", val + "");
//        Toast.makeText(view.getContext(), "Product id : " + val + "Invited by : "+ReferredItemArgs.fromBundle(getArguments()).getId2(), Toast.LENGTH_SHORT).show();
//        return view;
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        productsViewModel.currentProductsRepo.getProduct(ReferredItemArgs.fromBundle(getArguments()).getId1());
        ...
        productsViewModel.currentProduct.observe(getViewLifecycleOwner(), new Observer<Current_Product>() {
            @Override
            public void onChanged(Current_Product product) {
                if (product == null)
                    return;
